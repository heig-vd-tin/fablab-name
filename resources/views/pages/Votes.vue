    ...
    <div class="flex justify-end">
        <span class="isolate inline-flex items-end rounded-md shadow-sm">
            <button
                ...
                :class="{'bg-indigo-300': sortByScore}"
            ...
            <button
                type="button"
                class="relative -ml-px inline-flex items-center rounded-r-md border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-500 "
                data-bs-toggle="tooltip"
                :class="{'bg-indigo-300': !sortByScore}"
                data-bs-placement="bottom"
        ...
        >
            ...
            <div class="ml-3">
                <p class="text-sm font-medium text-gray-900">
                    {{ item.name }}
                    <span class="font-light text-slate-400 italic" v-if="item.user">— proposé par {{ item.user }}</span>
                </p>
