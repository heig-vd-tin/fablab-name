<template layout>
    <main class="dark:bg-gray-800 dark:text-gray-200">
        <img
        ...
        >
            ...
            >
                ...
                étudiant·e·es et aux collaborateurs·trices de l'école pour
                réaliser leurs projets académiques et privés en mettant à
                disposition des outils de fabrication et d'assemblage dans une
                atmosphère industrielle et professionnelle.
            </p>
        </section>
        <a href="#votes">
            <Arrowdown v-if="scollDownVisible"></Arrowdown>
        </a>
        <section class="mx-auto mt-16 max-w-3xl px-4 pb-10 sm:px-6 lg:px-8">
            ...
            <p class="pb-4 text-justify text-slate-800">
                La surface de l'atelier s'agrandit en offrant davantage de
                machines et d'outils pour nourrir la créativité et donner
                naissance aux idées innovantes de nos futur·es ingénieur·es.
            </p>
            <p class="pb-4 text-justify text-slate-800">
                Pourquoi changer de nom ? La terminologie FabLab (fabrication
                laboratory) est une franchise née au Media Lab du MIT en 2001.
                Ce nom impose certaines obligations auxquelles la
                <a href="http://heig-vd.ch">HEIG-VD</a> ne correspond pas. C'est
                pourquoi notre espace de fabrication se cherche un nouveau nom.
            </p>
            <p class="pb-4 text-justify text-slate-800">
                Nous cherchons un nom qui reflète notre identité, un nom facile
                à prononcer.
            </p>
            ...
            <p class="mt-10 mb-5 text-justify">
                ...
                >
                    ...
                    <a href="#votes">au bas de la page</a> pour saisir tes
                    votes, car il ne reste que
                    <strong
                        >{{ days }} jours,
                        <span v-if="hours > 0">
            ...
            <p class="pb-4 text-justify text-slate-800">
                La première place du classement sera récompensée par un bon
                d'une valeur de <strong>150 francs</strong> à la
        ...
        <section class="mx-auto mt-10 max-w-3xl px-4 pb-10 sm:px-6 lg:px-8">
            ...
            <p class="pb-4 text-justify text-slate-800">
                L'actuel espace est accessible sur le site de Cheseaux dans le
                local C08. L'accès est réservé à celles et ceux qui ont signé
                les règles d'utilisation. Certaines machines ne sont accessibles
                qu'après une formation. Pour plus d'informations, n'hésite pas à
                te rendre sur le
                <a
            ...
            <p class="pb-4 text-justify text-slate-800">
                Cet espace est utilisé pour l'enseignement, notamment dans le
                cadre des projets multidisciplinaires, mais également pour les
                étudiant·e·s qui désirent de créer et collaborer. Au FabLab,
                vous pouvez disposer d'outillages, d'imprimantes 3D, de
                nombreuses machines telles que graveuse et découpeuse laser
                ainsi que d'un certain nombre de consommables en libre-service.
            </p>

            <p class="pb-4 text-justify text-slate-800">
                En 2022, une extension a été prévue pour accueillir plus de
                monde et plus d'équipement. Voici le plan de l'extension :
            </p>
        ...
        <section class="mx-auto mt-16 max-w-3xl px-4 pb-10 sm:px-6 lg:px-8">
            ...
            <div v-if="next_suggestion_in > 0">
                <p class="mt-10 mb-5 text-justify">
                    ...
                    >
                        ...
                        proposer un nom que toutes les
                        <strong>24 heures</strong>. Patience donc, car tu
                        pourras à nouveau proposer un nom dans
                        <strong
                            >{{ hours }} heures et {{ minutes }} minutes</strong
                        >.
                    </vue-countdown>
                </p>
            </div>
            <div v-else>
                <p class="mb-5 text-justify">
                    ...
                    percutant, simple à prononcer et à retenir et à la
                    symbolique compatible avec les mots-clés : laboratoire,
                    atelier, étudiants, ingénieurs, projets, réalisation,
                    technologie, création, prototypage, hackerspace, open
                    design, hacker culture, fabrication, innovation, créativité
                    et bien entendu l'esprit maker...
                </p>
                <p class="mb-5 text-justify">
                    <strong>Attention</strong>, une fois la proposition validée,
                    tu ne pourras plus la modifier ou la supprimer. Tu peux
                    prendre connaissance des noms déjà existants plus bas.
                </p>
            ...
            <div class="mx-auto max-w-3xl pb-10 pt-5">
                ...
                <ul class="mb-10 list-inside list-decimal pl-2">
                    <li class="mb-2">
                        ...
                        <span class="font-bold">souvent</span> que tu le
                        souhaites jusqu'à la fin de la campagne.
                    </li>
                    <li class="mb-2">
                        Tu possèdes <span class="font-bold">trois</span> votes
                        que tu peux en tout temps modifier (un vote peut-être
                        positif ou négatif).
                    </li>
                    <li class="mb-2">
                        Tu as la possibilité de proposer un nouveau nom
                        <span class="font-bold"
                            >une fois toutes les 24 heures</span
                        >.
                    </li>
                    <li class="mb-2">
                        Un nom en dessous de
                        <span class="font-bold">-5 votes</span> sera
                ...
                <dl class="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-3">
                    <div
                        class="m-2 rounded-lg bg-white px-2 py-3 shadow sm:p-6"
                    >
        ...
        <section
            class="mx-auto mt-5 px-20 md:container"
        ...
        >
            ...
            <a
                href="https://github.com/heig-vd-tin/fablab-name"
                target="_blank"
            >
...
const scollDownVisible = ref(true)

const onElementVisibility = (isVisible: boolean) => {
    scollDownVisible.value = !isVisible
}
